...
echo ""
echo "  🛑  To stop: runpodctl serverless delete $ENDPOINT_ID"
echo ""
echo "  🌐 Cloudflare Worker (stable URL):"
echo "     ./apps/ios/scripts/update-cf-worker.sh https://api.runpod.ai/v2/$ENDPOINT_ID"
echo "========================================"
